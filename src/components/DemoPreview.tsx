  ...
  useEffect(() => {
    ...
    const run = () => {
      ...
      TYPING_VALUE.split('').forEach((_, i) =>
        t(
          () => setTypedValue(TYPING_VALUE.slice(0, i + 1)),
          afterLabel + 100 + i * 150
        )
      );
      ...
      t(() => {
        setStep('submitted');
        setChartData(CHART_DATA_UPDATED);
      }, afterValue + 700);
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-3 overflow-hidden p-4">
        ...
        <div className="border-border overflow-hidden rounded-xl border p-3">
          <div className="text-primary-text mb-2 flex items-center gap-1.5 text-xs font-semibold">
        ...
        <div className="border-border rounded-xl border p-3">
          ...
          <ul className="flex flex-col gap-1">
            {[
              'Reduza gastos com alimentação fora',
              'Reserve 20% do salário todo mês',
            ].map((d) => (
              <li
                key={d}
