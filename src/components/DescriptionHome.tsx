...
const DescriptionHome = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-12">
      ...
      >
        <span className="bg-primary/10 text-primary-text rounded-full px-4 py-1 text-sm font-medium">
          {t('description.label')}
        </span>
        <h2 className="max-w-xl text-4xl leading-tight font-bold">
          {t('description.title')}{' '}
      ...
      <motion.div
        ...
        style={{
          filter:
            'drop-shadow(0 24px 48px color-mix(in oklch, var(--color-primary) 15%, transparent))',
        }}
      >
        <DemoPreview />
      </motion.div>
